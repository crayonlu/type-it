  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        desc: 'gns3实验',
        time: '2025-10-30',
        docs: `${BLOG_DOCS_BASE}/计网/net/gns3组网.md`,
        tags: ['配网', '模拟', 'gns3'],
        cover: 'https://cdn.crayoncreator.top/Blog/计网/net/1.png',
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        desc: '搏击俱乐部 — 反叛与自我发现',
        time: '2025-10-30',
        docs: `${BLOG_DOCS_BASE}/我爱看电影/搏击俱乐部.md`,
        tags: ['反叛', '自我发现', '成长'],
        cover: 'https://cdn.crayoncreator.top/Blog/我爱看电影/搏击俱乐部.png',
      },
    ],
  },
  {
